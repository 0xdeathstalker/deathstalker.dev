...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-shadow-md font-sans font-black dark:text-neutral-600 cursor-default select-none absolute bottom-0 left-0 right-0 text-6xl md:text-[140px] lg:text-[180px] xl:text-[210px] translate-y-[15%] tracking-tighter uppercase text-center mx-auto text-neutral-400">
        dthstlkr
      </h1>
    </footer>
  );
